...
1. **Identifier la part LDTR** — quels travaux sont soumis, quels travaux sont libres
2. **Calculer la hausse admissible** poste par poste, avec les paramètres réglementaires actuels
3. **Modéliser le DCF avec période de contrôle** — revenus plafonnés pendant 3-10 ans, puis libération progressive
4. **Comparer avec l'alternative** — ne pas rénover (et subir le brown discount) vs rénover (et subir le plafonnement)
